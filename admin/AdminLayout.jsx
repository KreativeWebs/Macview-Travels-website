...
import AdminSocketNotifications from "./src/components/AdminSocketNotifications";
...
export default function AdminLayout() {
  ...
  useEffect(() => {
    ...
    if (!fetchingUser && (!user || user.role !== 'admin')) {
      // Use route relative to router basename (this will result in /admin/login when served under /admin)
      navigate('/login');
    }
